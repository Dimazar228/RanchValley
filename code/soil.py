...
class Plant(pygame.sprite.Sprite):
    def __init__(self, plant_type, group, soil, check_watered):
        ...
        self.rect = self.image.get_rect(midbottom=soil.rect.midbottom + pygame.math.Vector2(
            0, self.y_offset))
    ...
    def grow(self):
        if self.check_watered(self.rect.center):
            ...
            self.rect = self.image.get_rect(midbottom=self.soil.rect.midbottom + pygame.math.Vector2(
                0, self.y_offset))
...
class SoilLayer:
    ...
    def create_soil_grid(self):
        ...
        for x, y, surface in load_pygame('../data/map.tmx').get_layer_by_name('Farmable').tiles():
            ...
            for index_col, cell in enumerate(row):
                if 'X' in cell:
                    ...
                    SoilTile(pos=(index_col * TILE_SIZE, index_row * TILE_SIZE),
                             ...
                             group=[self.all_sprites, self.soil_sprites])
